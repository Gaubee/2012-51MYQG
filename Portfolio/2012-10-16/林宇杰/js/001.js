...
var reg=/^\w{6,18}$/g;
if(!reg.test(m1)){alert("抱歉！密码为6-18位数字或英文");return;}
...
var a=document.form1.user.value;
var b;
x=document.form1.sex[0].checked;
if(x){b=document.form1.sex[0].value}
else{b=document.form1.sex[1].value}
...
function ccc()
{
var y=document.form1.user.value;
if(y=="" || y==null || y=="请输入用户名"){alert("抱歉！请输入用户名");
...
function tijiao(){alert(提交成功，谢谢您的支持)}